...
export default function LeaderboardPage() {
  ...
  return (
    <div>
      ...
      {/* ── Table header ── */}
      <div
        className="grid grid-cols-[auto_1fr_auto] gap-5 pl-5 pr-5 py-3 mb-3 rounded-xl"
        style={{ background: "linear-gradient(90deg,#1a00d9 0%,#3a2fe8 50%,#5e9eff 100%)" }}
      >
        <p className="text-[10px] font-black uppercase tracking-widest text-white/70 w-48">Team</p>
        <p className="text-[10px] font-black uppercase tracking-widest text-white/70">Use Case</p>
        <p className="text-[10px] font-black uppercase tracking-widest text-white/70">Scores</p>
      </div>
